    ...
    return (
        <AppScrollbar>
            <WhiteCard color="white" className={styles.root}>
                ...
                <Text tag="p" size="large">
                    Она может преобразоваться и частично выводится вовне для взаимодействия с внешним миром. А часть её остается внутри и составляет внутренний мир человека.
                </Text>
