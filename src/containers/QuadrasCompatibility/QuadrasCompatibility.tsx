        ...
        <WhiteCard color="white" className={styles.root}>
            ...
            <div className={styles.fireBlock}>
                ...
                <div>
                    ...
                    <Text tag="p" className={styles.text}>
                        <i>Муж <mark className={styles.earth}>Инспектор</mark> и жена <mark className={styles.water}>Наставник</mark> живут в общежитии. Поскольку жена — общительный экстраверт, то муж очень часто ревнует ее к соседям. При этом сцена каждый раз разыгрывается почти по Шекспиру: «Ты с кем была ?» — спрашивает он и берет ее руками за шею. Она вскрикивает, и он испуганно отпускает ее.</i>
                    </Text>
            ...
            <Text tag="p" className={styles.text}>
                <i>Так, женщина-<mark className={styles.earth}>Хранитель</mark> была очень удивлена, когда мужчина-<mark className={styles.air}>Лирик</mark> сильно сжимал ее в своих объятиях, — ей пришлось «переучивать» его.</i>
            </Text>
            ...
            <div className={styles.waterBlock}>
                ...
                <div>
                    ...
                    <Text tag="p" className={styles.text}>
                        <mark className={styles.air}>Критик</mark> подчиняется, даже если его просто решительно взять за руку. Он говорит: «Если меня взять и повести, то я сразу пойду и не буду сопротивляться, поддамся контролю партнер».
                    </Text>
