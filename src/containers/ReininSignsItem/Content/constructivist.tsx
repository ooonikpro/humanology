...
export default function Constructivist() {
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" className={styles.text}>
                Важны эмоциональные «якоря», связанные с определенным местом, книгой, фильмом, которые «резонируют» с внутренними эмоциональными состояниями. С их помощью он удерживает или усиливает свое эмоциональное состояние.
            </Text>
            ...
            <Text tag="p" size="h6" className={styles.text}>
                Поэтому тенденция — каким-либо способом улучшить свое настроение.
            </Text>
