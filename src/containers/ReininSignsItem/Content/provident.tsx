    ...
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" size="h6" className={styles.text}>
                Восприятие проблемной ситуации происходит через узнавание в ней знакомых черт, а поиск решения проблемы ведётся с привлечением всего накопленного опыта, своего и чужого, как для подобных ситуаций, так и для любых других.
            </Text>
            ...
            <Text tag="p" className={styles.text}>
                Хорошо чувствуют время, умеют правильно распределять в нем работу, сортировать дела по срочности. Уверенно себя ощущают в ситуациях дефицита времени.
            </Text>
