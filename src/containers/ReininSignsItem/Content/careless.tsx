    ...
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" size="h6" className={styles.text}>
                Восприятие проблемной ситуации происходит через обнаружение в ней новых, незнакомых черт, а поиск решения проблемы ведётся в рамках текущей ситуации.
            </Text>
            ...
            <Text tag="p" className={styles.text}>
                Высокая чувствительность к реальным физическим запахам. Предпочитают «чистый» тонкий вкус продуктов, без вкусовой смеси и без заглушки интенсивным вкусом сахара, — тут специалисты по слабым сигналам выбирают изолированные слабосигнальные детали и части, а не смешанное интегральное целое.
            </Text>
