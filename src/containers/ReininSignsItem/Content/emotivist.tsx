    ...
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" size="h6" className={styles.text}>
                Регулирует своё эмоциональное состояние путем поиска новых переживаний, поскольку не обладает способностью точно и в течение длительного времени воспроизводить ранее пережитые эмоции.
            </Text>
