...
export default function Strategist() {
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" className={styles.text}>
                Трудно соразмерять свои финансовые возможности с желаниями и потребностями, поэтому уступают тактикам в грамотном планировании личного бюджета, зато чаше и легче срываются в прямую агрессию и в рукоприкладство — проблема с торможением.
            </Text>
