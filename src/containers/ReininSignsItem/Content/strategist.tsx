...
export default function Strategist() {
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" className={styles.text}>
                После каждого предпринятого действия происходит сверка результата с конечным желаемым состоянием. Фиксируют своё внимание на точке, в которую они хотят попасть, на цели своих действий, а не на самих действиях, происходящих событиях.
            </Text>
            ...
            <Text tag="p" className={styles.text}>
                ...
                «держать цель» и сосредоточивать своё воображение на главной информации и главных проблемах,игнорируя мелочи и побочные ассоциации.
            </Text>
            <Text tag="p" className={styles.text}>
