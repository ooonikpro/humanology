...
export default function Stubborn() {
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" className={styles.text}>
                «Упрямый» ученый может написать детализированный труд, отслеживающий различные версии возможных логических возражений. Но главное в нем может утонуть в куче второстепенных мелочей.
            </Text>
