    ...
    return (
        <AppScrollbar hideTabs>
            <WhiteCard color="white" className={styles.root}>
                <PageTitle iconName='PresentationChart' back>Тесты</PageTitle>
                ...
                <div className={styles.test}>
                    ...
                    <Text tag="p" className={styles.text}>
                        <i>Лично я сомневаюсь в достоверности любых тестов, но этот, судя по отзывам, вроде является самым точным.</i>
                    </Text>
                ...
                <div className={styles.test}>
                    ...
                    <Text tag="p" className={styles.text}>
                        <i>Разработан в 1956 году профессором Калифорнийскоrо университета Дэвидом Кейрси для изучения типичных способов поведения и личностных особенностей. </i>
                    </Text>

                    <Text tag="p" className={styles.text}>
                        Содержит 70 вопросов.
