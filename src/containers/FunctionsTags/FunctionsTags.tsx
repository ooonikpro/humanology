    ...
    return (
        <AppScrollbar>
            <WhiteCard color="white" className={styles.root}>
                ...
                <Text tag="p" className={styles.text}>
                    Мир и себя человек видит по этим функциям как бы извне, стремится к объективности и универсальности. Выдаваемая информация обезличена, находит свое воплощение в словесной форме.
                </Text>
