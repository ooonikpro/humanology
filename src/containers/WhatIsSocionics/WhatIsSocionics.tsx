    ...
    return (
        <WhiteCard color="white" className={styles.root}>
            ...
            <Text tag="p" size="large">
                Много копий сломано с 80-ых годов. Были несколько волн повального увлечение соционикой в СССР и России, на западе точно такая же ситуация с MBTI. Волны, как правило, носят стихийный характер.
            </Text>
