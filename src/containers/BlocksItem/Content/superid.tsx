    ...
    return (
        <div className={styles.root}>
            ...
            <Text tag="ul" className={styles.list}>
                ...
                <Text tag="li">
                    Умение принимать поддержку. Как отдельная задача, потому что поддержку не всегда легко принять. Человек может и готов её предоставить, но человек сидит закрытый, поддержку не принимает, не отдыхает и поэтому «сохнет, чахнет и дохнет».
                </Text>
                <Text tag="li">
