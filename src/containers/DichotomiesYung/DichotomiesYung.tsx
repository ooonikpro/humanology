    ...
    return (
        <AppScrollbar>
            <WhiteCard color="white" className={styles.root}>
                ...
                <AuthorLine text='Читать 7 минут' iconName='Unknown'>Интернет</AuthorLine>
                ...
                <Text tag="p" className={styles.text}>
                    Юнг отмечал, что в мире нет ни чистых экстравертов, ни чистых интровертов, но каждый индивидуум более склонен к одной из этих установок и действует преимущественно в ее рамках.
                </Text>
