...
export default function Sensory() {
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" size="h6" className={styles.text}>
                Из-за того, что сенсорики постоянно отслеживают текущий момент, им бывает сложно заглянуть в будущее, и почувствовать возможности, которые несёт в себе ситуация.
            </Text>
