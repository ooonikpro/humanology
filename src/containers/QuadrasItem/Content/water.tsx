...
export default function Water() {
    return (
        <div className={styles.root}>
            ...
            <PageBreak iconName='Water'>Вода</PageBreak>
            ...
            <div className={styles.waterBlock}>
                ...
                <Text tag="p" className={styles.text}>
                    Реформа, параллельно изменяющая не только структуру власти, материальные ресурсы и приоритеты развития, систему ценностей, веру.Перенос приоритета со всего общества на приоритет личности — Мы → Я.
                </Text>

                <Text tag="p" className={styles.text}>
                    <mark className={styles.fire}>Политик</mark> в этом блоке, безусловно, сила, но только его дуал <mark className={styles.air}>Критик</mark> может скоординировать процесс, собрать всю информацию и предостеречь от ошибок.
                </Text>
            </div>
            ...
            <div className={styles.waterBlock}>
                ...
                <Text tag="p" className={styles.text}>
                    Перенос приоритета на личность путем утверждения идеалов благосостояния, духа соревнования, конкуренции. Кредо <mark className={styles.water}>Предпринимателя</mark> — автономия, в том числе постоянное желание личных практических достижений. Это самый прагматичный и выносливый из всех интуитов. Идеальный реализатор реформ, тонко чувствующий развитие конкретной ситуации.
                </Text>

                <Text tag="p" className={styles.text}>
                    <mark className={styles.earth}>Хранитель</mark> — носитель веры, уверенности в своих силах, в дружбе. Силой своей веры он способен вытащить из «болота», вернуть вкус к жизни. Может радикально решать проблемы морали волевыми методами в месте их появления.
                </Text>
            </div>
