    ...
    return (
        <div className={styles.root}>
            ...
            <div className={styles.fireBlock}>
                ...
                <Text tag="p" className={styles.text}>
                    Стабилизируют иерархию — Инспектор создает логически обоснованные правила построения общества, а Наставник распространяет их, тонко играя на эмоциональных струнах и вдохновляя идеями, сплачивающими людей в единое целое.
                </Text>

                <Text tag="p" className={styles.text}>
                    Кроме того, Инспектор организует порядок в области материального производства и распределения ресурсов, а также занимается подготовкой — обучением профессиональных кадров.
                </Text>
            </div>
            ...
            <div className={styles.fireBlock}>
                ...
                <Text tag="p" className={styles.text}>
                    Концентрация сил, средств, власти и построение империи. Рассматривая всех людей в качестве «винтиков», можно собрать и заставить работать механизм. Такой подход оправдан, ведь основная масса человечества несовершенна, понимает только силу. Именно в таких условиях Лидер максимально реализует себя.
                </Text>

                <Text tag="p" className={styles.text}>
                    Лирик является этическим компенсатором в жестких условиях развития империи и реально помогает преодолеть крутые повороты судьбы — не сломаться и дуалу, и многим другим — в этом его отнюдь не легкая миссия.
                </Text>
            </div>
