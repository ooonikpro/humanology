    ...
    return (
        <div className={styles.root}>
            ...
            <div className={styles.earthBlock}>
                ...
                <Text tag="p" className={styles.text}>
                    Создает общество изобилия, используя оточенные технологии, мастерсттво и постоянно качественно улучшает жизнь, добиваясь максимальной отдачи и эффективности.
                </Text>

                <Text tag="p" className={styles.text}>
                    Новые высокие стандарты — моральные и технологические. Идеалы этого блока являются определяющими в формировании таких общечеловеческих ценностей как практичность — Администратор и гуманность — Гуманист.
                </Text>
            </div>
            ...
            <div className={styles.earthBlock}>
                ...
                <Text tag="p" className={styles.text}>
                    Мастер совершенствует окружающее пространство, социально раскрепощает людей, дает шанс для самореализации каждого конкретного человека — раскрытия всех его потенциальных возможностей, талантов.
                </Text>
            </div>
