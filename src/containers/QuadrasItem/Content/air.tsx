...
export default function Air() {
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" size="h6" className={styles.text}>
                Стереотипное, шаблонное мышление не приветствуется, одобряют умение мыслить за рамками, находить нестандартные подходы, активно использовать своё воображение.
            </Text>
            ...
            <Text tag="p" className={styles.text}>
                Им нравится ломать старые, отжившие своё подходы и принципы, избавляться от всего старого и уже неспособного функционировать с прежней эффективностью.
            </Text>
