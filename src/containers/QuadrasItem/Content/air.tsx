    ...
    return (
        <div className={styles.root}>
            ...
            <div className={styles.airBlock}>
                ...
                <Text tag="p" className={styles.text}>
                    Революционные и зачастую шокирующие идеи Новатора и его безапелляционность дополняются, уравновешиваются эмоциональной поддержкой, которую старается создавать Диплома.
                </Text>
            </div>
