    ...
    return (
        <div className={styles.root}>
            ...
            <div className={styles.airBlock}>
                ...
                <Text tag="p" className={styles.text}>
                    Революционные и зачастую шокирующие идеи Новатора и его безапелляционность дополняются, уравновешиваются эмоциональной поддержкой, которую старается создавать Дипломат.
                </Text>
            </div>
            ...
            <div className={styles.airBlock}>
                ...
                <Text tag="p" className={styles.text}>
                    Активируются в условиях хаоса — Энтузиаст осуществляет контроль эмоциональной энергии (обычно огромной), где он напоминает человека в одиночку управляющего ядерным реактором.
                </Text>

                <Text tag="p" className={styles.text}>
                    Аналитик оценивает события и поступки людей с позиции своей правды, создавая новую систему ценностей и логически обосновывая все действия дуала, доказывая их необходимость и справедливость.
                </Text>
            </div>
