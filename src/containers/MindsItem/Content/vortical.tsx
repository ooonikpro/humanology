...
export default function Vortical() {
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" className={styles.text}>
                <i>В настоящее время термин синергетика продолжает дискутироваться. В западных источниках её именуют теорией хаоса или нелинейной динамикой. Для наших целей важно знать, что она занимается так называемыми диссипативными структурами — неравновесными, нелинейными, зыбкими.</i>
            </Text>
            ...
            <Text tag="p" className={styles.text}>
                <i>В свободной экономике, например, действует «невидимая рука рынка» А. Смита: происходят циклические колебания спроса и предложения, которые и порождают естественную цену товара. Изучая биологическую эволюцию, Ч. Дарвин открыл, что её источником является борьба за существование и выживание наиболее приспособленных организмов. </i>
            </Text>
