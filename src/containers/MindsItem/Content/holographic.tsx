...
export default function Holographic() {
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" className={styles.text}>
                <i>В ней оказываются наложенными друг на друга два отдельных луча света, причем это происходит так, что каждая часть голограммы несёт информацию обо всем объеме. Таким образом, за счет мысленного наложения нескольких проекций одного и того же объекта голографисты достигают эффекта объемности. Для этого они смотрят сквозь изображение и подбирают нужную дистанцию рассматривания.</i>
            </Text>
            ...
            <Text tag="p" className={styles.text}>
                Так мыслит <mark className={styles.fire}>Лидер</mark> в бою. Анализируя ситуацию, он упрощает её до двух-трех проекций (фронтальной, с фланга, с тыла), но зато быстро выходит на более высокий уровень понимания.
            </Text>

            <Text tag="p" className={styles.text}>
                <mark className={styles.air}>Аналитик</mark> выпукло схватывает проблему с альтернативных сторон, мысленно поворачивая ситуацию вокруг её смысловых осей.
            </Text>
            <Text tag="p" className={styles.text}>
            ...
            <Text tag="p" className={styles.text}>
                Если детерминисты объясняют поведение системы через составные части и связи между ними, то голографисты находят в ней новые качества, которые описываются дополнительными комбинаторными признаками, никак не вытекающими из её внутренней структуры.
            </Text>
