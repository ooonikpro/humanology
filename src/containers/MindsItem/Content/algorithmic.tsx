...
export default function Algorithmic() {
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" className={styles.text}>
                Алгоритмическое мышление также хорошо решает задачи на классификацию, поскольку имеет дар распознавания сложных образов. За условиями задачи оно усматривает типичный алгоритм её решения.
            </Text>
            ...
            <Text tag="p" className={styles.text}>
                Схема алгоритма состоит из блоков и стрелок, показывающих порядок переходов, ветвления и циклы. Причем главным в программе является её динамическая часть — стрелки, а не блоки. Формула «если — то — иначе» и есть, по сути, ядро любого алгоритма.
            </Text>
