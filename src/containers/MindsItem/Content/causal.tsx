...
export default function Causal() {
    ...
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" className={styles.text}>
                <i>Если воспользоваться примером Аристотеля, который первым указал на четыре способа объяснения явлений, то причиной существования скульптуры является скульптор, который непосредственно ее вылепил.</i>
            </Text>
