...
export default function ESFP() {
    return (
        <>
            <AuthorLine readTime='5'>Виктор Гуленко</AuthorLine>
            ...
            <Text tag="p">
                Довольно неорганизован, склонен отвлекаться в работе на несущественные детали. Ему трудно долгое время концентрировать свое внимание на чем-то одном.
            </Text>
            ...
            <Text tag="p">
                Довольно консервативен к новому: ему нужно определенное время, чтобы воспринять и разобраться в новой технологии и убедиться в ее практичности.
            </Text>
            ...
            <Text tag="p" size="h6" color="role">
                Проявляет агрессивность, если его свободу ограничивают. Свое настроение переносит на окружающих.
            </Text>
