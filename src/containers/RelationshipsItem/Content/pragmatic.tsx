...
export default function Pragmatic() {
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" size="large" className={styles.text}>
                Легкое общение на любые темы, взаимопонимание, чувство равенства, ощущение безопасности, уравновешенность, искренние похвалы, подшучивания, расширение знаний и нормативов поведения.
            </Text>
