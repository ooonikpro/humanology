...
export default function Superego() {
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" size="large" className={styles.text}>
                Соперничество, непонимание, недоверие, необходимость подстраиваться, невольное причинение боли, трения, споры, ссоры, унижения, обиды, пустые обещания, желание отдалиться и не помогать, претензии в том, что партнер делает все назло, взимная глухота, отсутствие поддержки в делах, навязывание своей точки зрения, непонятность логики поведения, умалчивания о намерениях, критика, ощущение подвоха, острые конфликты, отчуждение.
            </Text>
