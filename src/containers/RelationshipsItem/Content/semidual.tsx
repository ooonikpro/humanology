    ...
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" size="large" className={styles.text}>
                «Полудуалы» прекрасно понимают устремления друг друга и готовы поддержать их. Партнерам интересно друг с другом, беседы не утомляют, а, наоборот, дарят хорошее настроение.
            </Text>
