...
export default function Underling() {
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" size="large" className={styles.text}>
                Усложнение простых вещей, желание делать все по-своему, трудности во взаимопонимании, непонимание и осуждение мотивов поступков, обиды, равнодушие, подозрения в ненадежности и измене, скрытое недовольство, удары по самолюбию, поучения «как не нужно делать», долгие споры при непринятии суждений партнера.
            </Text>
