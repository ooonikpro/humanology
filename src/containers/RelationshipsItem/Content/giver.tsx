...
export default function Giver() {
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" size="large" className={styles.text}>
                Заказчик должен проявлять уважение к подзаказному, показывать свое хорошее отношение, говорить слова поддержки, а подзаказному не стоит драматизировать события и не высказывать все в лицо заказчику.
            </Text>
