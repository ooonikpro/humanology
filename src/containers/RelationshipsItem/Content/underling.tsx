...
export default function Underling() {
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" size="large" className={styles.text}>
                Усложнение проблем, подчиненность и зависимость, несамостоятельность, навязчивость, непонимание со стороны партнера, стремление перевоспитывать, претензии, придирчивость, преувеличение недостатков, обидчивость, впечатлительность, уязвимость, ранимость, безысходность, изнурение, страдания.
            </Text>
