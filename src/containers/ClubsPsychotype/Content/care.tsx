    ...
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" className={styles.text}>
                Вопреки распространённым стереотипам, он вовсе не проводит жизнь на кухне, стремясь накормить и откомфортить каждого встречного, но ему нравится покровительствовать партнёру, заботиться о нём и он ценит, когда его заботу охотно принимают.
            </Text>
            ...
            <Text tag="p" size="h6" className={styles.text}>
                А в том, что заботливый, попадая, скажем, на чужую кухню, где стоит грязная посуда, испытывает дискомфорт. Ему неприятно видеть грязную посуду. И ему проще самому её помыть, чтоб уж наверняка, чем терпеть её наличие.
            </Text>
            ...
            <div className={styles.careBlock}>
                ...
                <Text tag="p" size="h6" className={styles.text}>
                    Опытный и внимательный к духовному миру женщины партнер, умеющий расположить её к себе покровительственным ухаживанием.
                </Text>
            ...
            <PageBreak iconName="Care">Заботливые</PageBreak>
