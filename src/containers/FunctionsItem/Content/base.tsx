...
export default function Base() {
    ...
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" className={styles.text}>
                Ее обычно не видно: она настолько находится «в» человеке, настолько направлена вовнутрь, а не на социальную оценку вовне, что часто ее процессы проходят незаметно для окружающих.
            </Text>
