...
export default function Creative() {
    ...
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" size="h6" color="accent" className={styles.text}>
                Отражает способ реализации личности, ее «стихию». Служит нам главным инструментом для достижения целей.
            </Text>
            ...
            <Text tag="p" className={styles.text}>
                Чтобы развить творческую функцию, необходимо попадать в такие кризисные ситуации, когда ее помощь требуется сразу и во многом.
            </Text>
