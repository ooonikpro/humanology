...
export default function Back() {
    ...
    return (
        <div className={styles.root}>
            ...
            <Text tag="p" className={styles.text}>
                С ее помощью, которая всегда работает фоном (отсюда и название), отслеживается вся информация по аспекту.
            </Text>
            ...
            <Text tag="p" size="h6" className={styles.text}>
                Фоновая функция реалистична, она не питает иллюзий, при этом она оценивает все детали, поскольку ее четырехмерность это позволяет.
            </Text>
