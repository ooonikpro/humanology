...
export const DETAIL_CARD_FUNCTIONS: DetailCardProps[] = [
    ...
    },
    {
        ...
        title: '',
        subtitle: 'Инструмент достижения целей. Наиболее изобретательно, творчески подходит к решению задач.',
        content: [
    ...
    },
    {
        ...
        title: '',
        subtitle: 'В процессе жизненного формирования выстраивает (больше в бессознательном) определенные жесткие правила, которым должно удовлетворять поведение людей из значимого окружения и своё собственно.',
        content: [
...
export const DETAIL_CARD_REININ: DetailCardReinin[] = [
    ...
    },
    {
        ...
        title: 'Объективный',
        subtitle: 'Ценят вопрос уместности проявления эмоций. Веселье для них ценно, если несёт в себе конкретную пользу.',
        content: [
