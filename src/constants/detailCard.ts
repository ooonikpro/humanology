...
export const DETAIL_CARD_REININ: DetailCardReinin[] = [
    ...
    },
    {
        ...
        content: [
            ...
            'Настроен в большей степени на то, что ему может принести какая-либо ситуация, контакт с людьми, чем на то, чего он мог бы вследствие этой ситуации лишиться, его потеряет.',
    ...
    },
    {
        ...
        content: [
            ...
            'Чувствует готовность окружающих, когда наступил подходящий момент чтобы выразить своих мыслей.',
    ...
    },
    {
        ...
        title: 'Эмотивист',
        subtitle: 'Считывают эмоциональную часть ситуации, а лишь потом способны ее осмысливать.',
        content: [
    ...
    },
    {
        ...
        content: [
            ...
            'Предпочитать формальные, официальные отношения.',
            'Рискуют выгореть на работе, переработать до больницы, истощить все силы, слишком поторопиться и принять неправильное решение.',
        ]
    },
    {
