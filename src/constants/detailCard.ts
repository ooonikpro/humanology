...
export const DETAIL_CARD_BLOCKS: DetailCardProps[] = [
    {
        ...
        title: 'Блок принятия решений, творчества',
        subtitle: 'Состоит из двух осознанных сильных функций.',
        content: [
    ...
    },
    {
        ...
        title: 'Блок индивидуального контроля',
        subtitle: '',
        content: [
    ...
    },
    {
        ...
        title: 'Блок социальной адаптации',
        subtitle: 'Совесть, социальные знания',
        content: [
    ...
    },
    {
        ...
        title: 'Блок индивидуальной деятельности.',
        subtitle: 'Слабые неосознанные функции',
        content: [
...
export const DETAIL_CARD_QUADRAS: DetailCardProps[] = [
    {
        type: 'quadra',
        quadra: 'air',
        tags: ['Альфа', 'Дети', 'Демократы', 'Рассудительные'],
        title: 'Воздух',
    ...
    },
    {
        type: 'quadra',
        quadra: 'fire',
        tags: ['Бета', 'Подростки', 'Аристократы', 'Решительные'],
        title: 'Огонь',
    ...
    },
    {
        type: 'quadra',
        quadra: 'water',
        tags: ['Гамма', 'Взрослые', 'Демократы', 'Решительные'],
        title: 'Вода',
    ...
    },
    {
        type: 'quadra',
        quadra: 'earth',
        tags: ['Дельта', 'Старики', 'Аристократы', 'Рассудительные'],
        title: 'Земля',
