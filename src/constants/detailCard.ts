...
export const DETAIL_CARD_REININ: DetailCardReinin[] = [
    ...
    },
    {
        ...
        content: [
            ...
            'Часто отвечают коротко, им важнее услышать собеседника, чем высказать свое мнение.',
    ...
    },
    {
        ...
        content: [
            ...
            'В разговоре склонны к монологу, меньше склонны задавать вопросы, предпочитают сами отвечать и высказывать свое мнение.',
            ...
            'Склонны давать развернутый ответ, им важнее высказать свое мнение, чем услышать собеседника.',
    ...
    },
    {
        ...
        content: [
            ...
            'Ценят вопрос уместности проявления эмоций (не будут шутить на работе, если будут считать это неуместным), веселье для них хорошо, если несет в себе конкретную пользу.',
