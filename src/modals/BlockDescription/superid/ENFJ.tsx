...
export default function ENFJ() {
    return (
        <>
            ...
            <Text tag="p">
                Ориентируется в подобной информации на уровне личного опыта, не желает сравнивать своё собственное понимание с общепринятым. Неадекватно реагирует на негативную оценку своей логичности.
            </Text>

            <Text tag="p">
                Хотел бы считать, что умеет сопротивляться волевому давлению, защищать своё жизненное пространство.
            </Text>
