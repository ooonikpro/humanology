...
export default function ESFJ() {
    return (
        <>
            ...
            <Text tag="p">
                Если нужно осознать сложную информацию, ему нужно ее преподнести в виде структуры, системы или наглядной таблицы, что отлично умеет делать его дуал Аналитик.
            </Text>
