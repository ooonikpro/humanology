...
export default function ENTP() {
    return (
        <>
            ...
            <Text tag="p">
                Это — нормально, поскольку человек <b>не имеет определенного паттерна поведения в отношениях и ему тяжело выстраивать корректные отношения</b> как с родственниками и друзьями, так и с коллегами и приятелями.
            </Text>
